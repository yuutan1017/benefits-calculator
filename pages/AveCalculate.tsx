...
import type { InputValue } from '../types/type';
...
const AveCalculate = () => {
  ...
  const handleCalculate = (): void => {
    let localTotal = 0;
    for (let [_key, value] of Object.entries(allState)) {
      localTotal += value;
    }
  ...
  return (
    <>
      ...
      <section className="mt-4 mb-2 bg-gray-300 border-t-2">
            ...
            <tbody>
              <tr className="flex flex-col">
                <td className="flex flex-row bg-gray-50 border-b-2 border-stone-400 h-10">
                  ...
                  />
                  <span className="text-gray-900 text-md mx-1.5 pt-1">円</span>
                </td>
                <td className="flex flex-row bg-gray-50 border-b-2 border-stone-400 mt-4 h-10">
                  <input
                    ...
                    className=" text-gray-900 text-md focus:outline-none w-full pl-2"
                  />
                  <span className="text-gray-900  text-md mx-1.5 pt-2">円</span>
                </td>
                <td className="flex flex-row bg-gray-50 border-b-2 border-stone-400 mt-4 h-10">
                  <input
                    type="number"
